...
Covid19DeathsTotal <-  vroom("../data/time_series_covid19_deaths_global.csv")
...
CovidCountryDataUKForDeaths = vroom("../data/overview_2021-10-18.csv")
...
UKHospitalAndDeathDailyData <-  vroom("../data/HospitalAndDailyDeathCovidData.csv")
...
WorldInformation <-   vroom("../data/WorldCovidData.csv")
